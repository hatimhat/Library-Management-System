...
if(isset($_REQUEST['sbt-book-btn']))
{
    ...
    $insert_book = mysqli_query($conn,"INSERT INTO tbl_book (book_name, isbnno, author, publisher, price, quantity, place, category, availability,virtual_link)
        VALUES ('$book_name', '$isbn', '$author_name', '$publisher_name', $price, $quantity, '$location_name', '$category_name', $availability, '$virtual_link')");
    if($insert_book > 0)
    {
        ?>
  ...
  <div class="card mb-3">
          ...
          <div class="card-body">
                           ...
                           <div class="form-group row">
                                      ...
                                      <div class="form-group row">
                                      <label class="col-lg-4 col-form-label" for="virtual_link">VL <span class="text-danger">*</span></label>
                                       <div class="col-lg-6">
                                      <input type="text" name="virtual_link" id="virtual_link"  class="form-control" placeholder="Enter virtual_link" >
                                      <a href="virtual_link">Link</a>
                                      </div>
                                  </div>
                                        <div class="form-group row">
